...
<div class="container shadow border p-5 mt-5 w-50" style="margin-left: 30%;">
	...
	<form action="/ci4/public/news/create" method="post" enctype='multipart/form-data'>
	    <?= csrf_field() ?>
		...
		if($update_data['id']){
		   ...
		   <?php 
			...
			?>
			  <button type="submit" class="btn btn-primary mt-2" name="submit">Create News</button>
			<?php
		}
		?>
	</form>
